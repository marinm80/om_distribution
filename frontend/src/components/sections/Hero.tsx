        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-emerald-300 text-sm font-medium tracking-wide">Springfield, MA — Northeast</span>
            </motion.div>
