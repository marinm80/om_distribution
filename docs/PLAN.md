...
- TailwindCSS 4 (tema en `@theme` dentro de `index.css`, sin `tailwind.config.js`)
- Redux Toolkit para estado global
- Framer Motion 12 para animaciones (importar desde `framer-motion`)
- Swiper 12 para carruseles
...
> 🔒 **Seguridad:** Ver especificación completa en [`docs/SECURITY.md`](./SECURITY.md). Se integra en Fases 1, 6 y 8.
